...
export default function ContactCTA() {
  return (
    <section className="relative py-20 lg:py-32 overflow-hidden bg-gradient-to-br from-[#D1DBE8] to-[#B3C2D1] font-sans">
        ...
        <div className="max-w-5xl flex flex-col items-start text-left w-full">
          ...
          <div className="flex flex-col sm:flex-row items-start gap-4 sm:gap-8 mb-6 lg:mb-8 w-full">
            ...
            <h2 className="text-4xl sm:text-5xl lg:text-[4.5rem] font-medium text-slate-800 leading-[1.05] tracking-tight flex-1">
              Ready to Build Your<br className="hidden sm:block" /> Industrial Career with<br className="hidden sm:block" /> Powerful Tech Skills? 
          ...
          <div className="flex flex-col sm:flex-row items-start gap-4 sm:gap-8 w-full">
            ...
            <div className="flex-1">
              <p className="text-lg lg:text-xl text-slate-600 mb-10 max-w-2xl font-normal leading-relaxed">
