...
export default function PlacementHero() {
  return (
    <section 
      className="relative w-full bg-slate-950 font-sans overflow-hidden py-24 lg:py-40 border-b border-slate-800"
      style={{
    ...
    >
      ...
      <div className="relative z-10 max-w-[1200px] mx-auto px-6 sm:px-8 lg:px-12 flex flex-col items-start">
        ...
        <h1 className="text-4xl sm:text-5xl lg:text-[5rem] font-semibold text-white mb-6 tracking-tight leading-[1.05] drop-shadow-2xl">
          Bridging the Gap Between <br className="hidden lg:block" /> Talent and Opportunity
        </h1>
