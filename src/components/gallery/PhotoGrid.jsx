...
export default function PhotoGrid() {
  ...
  const images = [
    ...
    { id: 2, category: 'Laboratories', src: 'https://res.cloudinary.com/w4kwyx1p/image/upload/v1784117495/classroom_itybkp.jpg', alt: 'Advanced Computer Lab' },
    ...
    { id: 4, category: 'Classrooms', src: 'https://res.cloudinary.com/w4kwyx1p/image/upload/v1784116448/mission_rarepf.jpg', alt: 'Smart Classroom Setup' },
    ...
    { id: 8, category: 'Campus', src: 'https://images.unsplash.com/photo-1656266724105-302774929dfd?q=80&w=2070&auto=format&fit=crop', alt: 'Student Ground & Greenery' },
    { id: 9, category: 'Laboratories', src: 'https://res.cloudinary.com/w4kwyx1p/image/upload/v1784118885/cyber_l4p5sz.jpg', alt: 'Cyber Security Lab' },
    ...
    { id: 11, category: 'Classrooms', src: 'https://images.unsplash.com/photo-1722573783625-eceb04251036?q=80&w=2070&auto=format&fit=crop', alt: 'Interactive UI/UX Session' },
            ...
            <div className="flex flex-wrap justify-center gap-3 sm:gap-4 mb-4">
              {categories.map((cat) => (
                <button
                  ...
                  className={`px-5 py-3 md:px-6 md:py-3 rounded-[2rem] font-bold text-sm md:text-base transition-all duration-300 shadow-sm hover:shadow-md hover:-translate-y-1 ${activeFilter === cat
